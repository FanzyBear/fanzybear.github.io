...
![Webhook Output](assets/maldev/discord-webhook-keylogger/jeba.png){: .normal w="700" h="300" style="border-radius: 16px;" }
...
2. Masquerading: Renames to .dll in System32—looks legitimate.
